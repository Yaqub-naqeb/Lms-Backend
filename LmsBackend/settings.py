...
SECRET_KEY = "django-insecure-rlu^dmouuz6zfo4vz8dhq+n8az%_qm6d$#*^f00=z2b*8@9910"
...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_LIFETIME_REFRESH_LIFETIME': timedelta(days=30),
}
...
AUTH_SER_MODEL='StudentApi.User'
